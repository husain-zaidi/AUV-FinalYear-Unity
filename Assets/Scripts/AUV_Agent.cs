...
public class AUV_Agent : Agent
{
    ...
    {
        //Actions 4
        rBody.AddForceAtPosition(transform.up * vectorAction[0] * speed, thrusterLeft.position);
        rBody.AddForceAtPosition(transform.up * vectorAction[1] * speed, thrusterRight.position);

        rBody.AddForceAtPosition(transform.right * vectorAction[2] * speed, thrusterFront.position);
        rBody.AddForceAtPosition(transform.right * vectorAction[3] * speed, thrusterBack.position);
        ...
        float facingDot = Vector3.Dot(directionToTarget.normalized, transform.up);
